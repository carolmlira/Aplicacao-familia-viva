    ...
    <div className={styles.redes}>
      ...
      <div className={styles.redesCard}>
        ...
        <div className={styles.redesDescricao}>
          <h3>Rede Kids</h3>
          <Link className={styles.linkRede} href="/redes/rede-kids">
            Ver mais
          </Link>
          <p>
            ...
            tenetur maiores corrupti vitae dicta nisi veniam rem mollitia nulla!
            Et commodi voluptatibus non sit debitis, laudantium veniam assumenda
            beatae nihil.
          </p>
        </div>
      </div>
      ...
      <div className={styles.redesCard}>
        ...
        <div className={styles.redesDescricao}>
          <h3>Rede Jovem</h3>
          <Link className={styles.linkRede} href="/redes/rede-jovem">
            Ver mais
          </Link>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quisquam
      ...
      <div className={styles.redesCard}>
        ...
        <div className={styles.redesDescricao}>
          <h3>Rede Mulheres</h3>
          <Link className={styles.linkRede} href="/redes/rede-mulheres">
            Ver mais
          </Link>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quisquam
